package com.senyint.image.imageretrieverhttp.datasource.druid.configuration;

import com.alibaba.druid.pool.DruidDataSource;
import com.senyint.image.imageretrieverhttp.mybatis.configuration.MybatisConfig;
...
//      SqlSessionFactory sessionFactory = builder.build(new MybatisConfiguration().mybatisConfig());
        sessionBean.setConfiguration(new MybatisConfig().configuration());
